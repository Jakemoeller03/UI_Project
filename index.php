...
<body class="bg-gray-100 p-6">
        <div class="max-w-6xl mx-auto">
                <h1 class="text-3xl font-bold text-center mb-6">Minerals for Sale</h1>
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                        <?php foreach ($minerals as $mineral): ?>
                                <div class="bg-white rouded-lg shadow-lg p-4">
                                        <div class="sketchfab-embed-wrapper">
                                                <iframe title="<?php echo htmlspecialchars($mineral['title']); ?>"
                                                        frameborder="0" allowfullscreen mozallowfullscreen="true"
                                                        webkitallowfullscreen="true" allow="autoplay; fullscreen; xr-spatial-tracking"
                                                        src="<?php echo htmlspecialchars($mineral['sketchfabUrl']); ?>">
                                                </iframe>
                                        </div>
                                        ...
                                        <p class="text-lg font-bold mt-2">$<?php echo number_format($mineral['price'], 2); ?></p>
                                        <a href="item.php?id=<?php echo urlencode($mineral['id']); ?>" class="text-blue-500">View</a>
                                </div>
                        <?php endforeach; ?>
                </div>
        </div>
